...
Commands to run:
```bash
bd list --status done --labels "spec:<change>"
bd list --status blocked --labels "spec:<change>"
```
...
Based on:
- https://github.com/lucastamoios/celeiro/tree/master/.claude/skills/beads-retrospective
...
You are executing **`/opsx-apply`**, a thin OpenSpec command wrapper.

Apply OpenSpec tasks. For Skillgrid checkpoints, PRD status, and handoff updates use `/skillgrid-apply`.

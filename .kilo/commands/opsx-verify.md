...
You are executing **`/opsx-verify`**, a thin OpenSpec command wrapper.

Verify implementation against OpenSpec artifacts. For combined Skillgrid validation use `/skillgrid-validate`.
...
Read and follow `.agents/skills/openspec-verify-change/SKILL.md`.

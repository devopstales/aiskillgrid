<!--
  Template source: https://raw.githubusercontent.com/adr/madr/refs/heads/develop/template/adr-template.md
  Project: MADR (Markdown Any Decision Records) — https://github.com/adr/madr
  SPDX-License-Identifier: MIT
  Copy to `.skillgrid/adr/NNNN-short-title-in-kebab-case.md`; replace placeholders and remove unused sections.
-->
---

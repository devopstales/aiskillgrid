...
| **Agentic pipeline** | A sequence of command-driven phases (`/sdd-init`, `/sdd-explore`, `/sdd-brainstorm`, `/sdd-apply`, `/sdd-verify`, `/sdd-archive`) with tools and skills attached, not one long autonomous chat. |

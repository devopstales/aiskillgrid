...
| 05 | `openapi-and-polish` | `@step-05` | 04 | Feature tagged `@step-05` |

## Review workload (change-level)

| Field | Value |
|-------|-------|
| Estimated changed lines (change) | ~3500 (SPA ~2500, Go ~500, tests ~300, openapi ~200) |
...
> Depends on: 04-dashboard-backlog-sessions
...
**Interfaces:**
- Consumes: all routes from steps 01–04

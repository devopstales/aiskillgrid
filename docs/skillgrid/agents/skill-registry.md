...
| mnemonic | ALWAYS ACTIVE — Mnemonic memory, code index, and web cache protocol: proactive mem_save, code ladder, search router, sessions | `.agents/skills/mnemonic/SKILL.md` | project |
